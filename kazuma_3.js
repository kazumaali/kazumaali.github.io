function saveAllContent() {
    ...
    localStorage.setItem('aboutMeContent', textContent1.innerHTML);
    
    // Save Hire Me content
    localStorage.setItem('hireMeContent', hireTxt.innerHTML);
    
    // Save Social Media content
    localStorage.setItem('socialMediaContent', socialAcc.innerHTML);
    
    // Save Hire Me section visibility
